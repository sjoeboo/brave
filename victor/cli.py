...
@cli.command()
@click.option('-c', '--config', default="{}/.victor.yaml".format(home), help="Location of victor.yaml config")
...
@click.option('-c', '--config', default="{}/.victor.yaml".format(home), help="Location of victor.yaml config")
@click.option('-l', '--limit', default=5000, help="Limit sugestions")
@click.option('-t', '--threshold', default=10000, help="Threshold to consider a tag high cardinality")
